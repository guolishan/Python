...
class Stats(QWidget):
    def __init__(self, parent=None):
        ...
        # 按钮事件
        self.ui.Button_Upload.clicked.connect(self.handleUpload1)
    ...
    def handleUpload1(self):
        ...
        def insert_data(series):
            sql = "insert into t_co_error_code values(%s,%s,%s,F_C_GETNEWID(),%s,%s,%s,%s,%s,%s,%s,%s);"
            cur.execute(sql, ('3',series[0],'B','1','876ba569ddc24d73b81a7c44e3b2b085','','','',series[0],series[1],'1'))
        ...
        # 读取文件，MES 项目文件夹里有模板
        df = pd.read_excel(file_path, header=0,sheet_name= "维修-不良代码")
